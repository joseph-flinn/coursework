...
class ModelForm(Form):
    ...
    uses its own default whichy is to pass in request.form automatically.
    """
...
def convert_choices(source, prepend_blank=True):
    """
    Convert a given data structure to a format that's compatible with WTForm's
    choices. It also optionally prepends a "Please select one..." value.
    ...
    :return: list
    """
    # WIP: The above two functions look like they can be put into one.
    pass
